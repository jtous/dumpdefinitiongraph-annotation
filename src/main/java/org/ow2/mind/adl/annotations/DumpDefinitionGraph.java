 ...
 * @author Julien TOUS
 */
@ADLLoaderProcessor(processor = DumpDefinitionGraphAnnotationProcessor.class, phases = { ADLLoaderPhase.AFTER_PARSING })
public class DumpDefinitionGraph implements Annotation {
