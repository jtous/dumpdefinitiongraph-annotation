...
public abstract class AbstractDumpDefinitionGraphCompositeTest {

  protected DumpDefinitionGraphCompilerRunner runner;
  ...
  protected void setup() throws Exception {
    runner = new DumpDefinitionGraphCompilerRunner(getInitialContext());
  }
  ...
  protected void initSourcePath(final DumpDefinitionGraphCompilerRunner runner,
